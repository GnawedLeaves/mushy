...
// Adapted from reactbits.dev's TextPressure (https://reactbits.dev/text-animations/text-pressure),
// ported originally from https://codepen.io/JuanFuentes/full/rgXKGQ. Copy-paste
// component, no npm package -- kept close to the original, just typed.
